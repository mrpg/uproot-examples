...
load_config(uproot_server, config="chat_with_gpt", apps=["chat_with_gpt"])
...
load_config(uproot_server, config="custom_models", apps=["custom_models"])
...
load_config(uproot_server, config="mind_game", apps=["mind_game"])
...
load_config(uproot_server, config="prisoners_dilemma_fancy", apps=["prisoners_dilemma_fancy"])
...
load_config(uproot_server, config="sessionwide_timeout", apps=["sessionwide_timeout"])
