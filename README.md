...
| `prisoners_dilemma_fancy`                         | Standard prisoner's dilemma (more fancy)                        | Medium     |
...
| `sessionwide_timeout`                             | Session-wide timeout followed by code run by the first arrival  | Easy       |
